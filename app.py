...
def create_sample_csv():
    data = [
        ...
        ['Why do I want to shift to other course?','Reasons for shifting to another course can include new interests, exploring different career options, dissatisfaction, or better alignment with personal goals.'],
        ...
        ['When are major assignments/exam due for the course and what its point value?','Assess your level of motivation and commitment to shifting to another course to determine how badly you want to pursue it.'],
        ...
        ['How can I apply if I want to shift my course in college?','The required general weighing average from previous grades may or may not be considered, depending on the policies of the institution and the new course.'],
        ...
        ['Are there any units or courses that involve internships, field placements, or experiential learning opportunities?','Internships/placements integrated into some units.'],
